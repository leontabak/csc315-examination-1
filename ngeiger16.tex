...
\begin{enumerate}
 ...
 \begin{answer}
     Blocks are like lambda that is new in java.It is use to pass a function into another function.
     \end{answer}
...
\begin{answer}
    No. Java has the void statement.
    \end{answer}
 ...
 \begin{answer}
    (17) Ada constrains but gives up the flexability of Java.
    \end{anwser}
...
\begin{answer}
    Java array carries along the length of the array where as we need to help C know the length of its array.
    \end{end}
