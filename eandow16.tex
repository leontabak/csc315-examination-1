...
\begin{enumerate}
  ...
  \begin{answer}
    ...
    Grammar?? But seriously, an ambiguous grammar is a sort of
    context-free grammar (one for which a parse tree can be generated)
    which can produce more than one valid parse tree for some input.
